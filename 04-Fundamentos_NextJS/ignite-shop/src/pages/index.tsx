...
export default function Home() {
  ...
  return (
    <main
      className="keen-slider flex w-full max-w-screen-customScreen ml-auto min-h-[656px] "
      ref={slierRef}
    >
      <a
        href=""
      ...
      <a
        href=""
        className="keen-slider__slide relative bg-gradient-to-r from-[#1ea483] to-[#7465d4] rounded-lg p-1 cursor-pointer flex items-center justify-center opacity-[1] group"
      >
